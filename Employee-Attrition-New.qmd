...
# import dataset
df <-
  read_csv("HR-Employee-Attrition.csv", show_col_types = F)
...
- Handle the work activity and condition issues such as to reduce the amount of business travels, 
improve career development because it is the junior level employees who tend to leave the company
